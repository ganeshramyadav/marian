	...
	<div class="row" style="padding-top:5em;">
					...
					<div class="row">
						<div class="col-12">
							<div class="modal-content">
								...
								<div id='reference_check' class="modal-body" style="padding: 2px 7%;">
		...
		<div class="col-sm-6">
			...
			<div class="form-group" style="margin-bottom: auto;">
				...
				<input type="hidden" name="ssn_path" ng-model="q.ssn_path" value="<?php
				if (!empty($rn_info->ssn_path)) {
					echo $rn_info->ssn_path;
				}
				?>">
				<div class="col-sm-8">
					<div class="fileinput fileinput-new" data-provides="fileinput">
					   
						<?php if (!empty($rn_info->ssn)): ?>
							<a class="btn btn-default btn-file" href="<?php echo base_url() . $rn_info->ssn; ?>" target="_blank" >Print</a> 
							<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Upload file</span>
								<span class="fileinput-exists" style="display: block">Change</span>
								<input type="hidden" name="ssn" ng-model="q.ssn" value="<?php echo $rn_info->ssn?>">
								<input type="file" name="ssn" ng-model="q.ssn" >
							</span>
	...
	<!-- Initial Competency Assessment date -->
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-2" >
					<button id="Btn_CA" class="btn btn-default btn-file" style="margin-top: auto;">Print</button>
					<span class="btn btn-default btn-file"><span class="fileinput-new" >Upload file</span>       
				...
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-6">
							<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
							<div class="input-group">
								<input type="text" name="Initial_Competency_Assessment_date" ng-model="q.Initial_Competency_Assessment_date"  class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->Initial_Competency_Assessment_date;?>">
								<div class="input-group-addon">
									<a href="#"><i class="entypo-calendar"></i></a>
								</div>
							</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(evt){
		...
		$("#myBtnRC").click(function(e){
			$("#myModalRC").show();
			$("#reference_check").load("<?php echo base_url()?>employee/dashboard/reference_check/<?php echo $employee_details->uid ?>");
			return false;
		});
		$("#Btn_RC1").click(function(e){
			$("#myModalRC").show();
			$("#reference_check").load("<?php echo base_url()?>employee/dashboard/reference/<?php echo $employee_details->uid ?>");
			return false;
		});
		...
		$("#Btn_MHR").click(function(e){
			...
			$("#myModalRC").show();
		$("#reference_check").load("<?php echo base_url()?>employee/dashboard/mhr/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
	                      if(sign!="")
		...
		$("#reference_check").load("<?php echo base_url()?>employee/dashboard/oc/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
	                      if(sign!="")
		...
		$("#Btn_PAF").click(function(e){
                       var sign = $('#esignature').val();
			$("#myModalRC").show();
		$("#reference_check").load("<?php echo base_url()?>employee/dashboard/paf/<?php echo $employee_details->uid?>",'',function(response,status,xhr){
	                      if(sign!="")
		...
		$("#Btn_RFTO").click(function(e){
			$("#myModalRC").show();
		$("#reference_check").load("<?php echo base_url()?>employee/dashboard/rfto/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
	                      if(sign!="")
		...
		$("#Btn_HV").click(function(e){
			$("#myModalRC").show();
		$("#reference_check").load("<?php echo base_url()?>employee/dashboard/hv/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
		...
		$("#Btn_II").click(function(e){
			$("#myModalRC").show();
			$("#reference_check").load("<?php echo base_url()?>employee/dashboard/ii/<?php echo $employee_details->uid ?>");
			return false;
		});
		...
		$("#Btn_TB").click(function(e){
		        var sign = $('#esignature').val();
			$("#myModalRC").show();
			$("#reference_check").load("<?php echo base_url()?>employee/dashboard/tb/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
	                      if(sign!="")
		...
		$("#Btn_CA").click(function(e){	debugger;
			$("#myModalRC").show();
			$("#reference_check").load("<?php echo base_url()?>employee/dashboard/ca/<?php echo $employee_details->uid ?>",'',function(response,status,xhr){
				if(sign!="")
					$("#tb_signature").attr("src",sign);
			});
			return false;
