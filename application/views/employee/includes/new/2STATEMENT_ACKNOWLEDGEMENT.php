	...
	<form method="post" action="#">
		...
		<div class="row">
			<div class="row">
				...
				<div class="col-sm-3"><input id="last-name" class="form-control" style="display: inline;"/></div>
		...
		<hr class="heavy"/>
		<h2 style="text-align:center;">CONFLICT OF INTEREST DISCLOSURE STATEMENT</h2>
		<br />
		<div class="row">
			<span >
				<p style="margin-left: 1em;">I,<span><input id="last-name" class="form-control" style="display: inline;width: inherit;"/></span>an employee of Lifelink Health Providers, Inc. do hereby state that I will:</p>
			</span>
			<span>
		...
		<br />
		<hr class="heavy"/>
		<h2 style="text-align:center;">CORPORATE COMPLIANCE PLAN</h2>
		...
		<span style="font-size: initial;">
			<ol>
				<li type="I">
					...
					<p>
						Contractors, independent contractors, suppliers, agent and representatives are expected to comply with the Code Core Documents in their dealings with Lifelink Health Providers, Inc.
					</p>
				</li>
				<li type="I">
					...
					<span>
						<ol style="list-style-type: upper-alpha;">
							<li>
								...
								<p>
									As set forth in the Code, Lifelink Health Providers, Inc., as appropriate, will appoint a Corporate Compliance Officer (CCO).
								</p>
								<p>
							...
							<li>
								...
								<p>
									Lifelink Health Providers, Inc. will establish a Corporate Compliance Committee (CCC) to advise the compliance officer and assist the implementation of the compliance program. Members of the committee including the compliance officer shall be selected from individuals with varying responsibilities in the organization. These Committee members and compliance officer are expected to demonstrate high integrity, good judgments, assertiveness, and an approachable demeanor, while eliciting the respect and trust of employees and having significant professional experience working with billing, medical records, documentation and auditing principles.
								</p>
								<p>
							...
							<li>
								...
								<span>
									<ol style="margin-left: 2em;">
										...
										<li>
											Lifelink Health Providers, Inc. will retain adequate records of training of employees, including attendance logs and materials distributed at training sessions in a three-way binder.
										</li>
									</ol>
								</span>
							</li>
								...
								<span>
									<ol style="margin-left: 2em;">
										...
										<li>
											...
											<p>
												Lifelink Health Providers, Inc. will establish a hotline number when  financially feasible and other forms of information exchange, such as e-mails, written memoranda, newsletters, suggestion boxes, to maintain these open lines of communication.
											</p>
											<p>
											...
											<p>
												Lifelink Health Providers, Inc. will post in a prominent, available area the HHS-OIG Hotline telephone number, 1-800-447-8477 (1-800-HHS-TIPS), in addition to any company hotlines number that may be posted.
											</p>
											<p>
								...
								<span>
									<ol>
										<li>
											...
											<p>
												Lifelink Health Providers, Inc. will publish and disseminate the range of disciplinary standards, for improper conduct and to educate officers and employees regarding these standards.
											</p>
											<p>
										...
										<li>
											New Employee Policy
											<p>
												Lifelink Health Providers, Inc. will conduct a reasonable and prudent background check, including a reference check for all new employees who have discretionary authority to make decisions that may involve compliance with the law or compliance oversight, as part of every such employment application. The applicant will be required to disclose any criminal conviction, as defined by 42 U.S.C. & 1320a-7 (i), or exclusion action.
											</p>
											<p>
												Lifelink Health Providers, Inc. will not employ individuals, who have been recently convicted of a criminal offense related to health care or who are listed debarred, excluded, or otherwise ineligible for participation in federal health care programs.
											</p>
											<p>
							...
							<li>
								Auditing & Monitoring
								<p>
									Lifelink Health Providers, Inc. will incorporate thorough monitoring of its implementation of its compliance program and regular reporting to the Administrator and the governing body, in order to be effective program. Compliance reports created by this ongoing monitoring, including reports of non-compliance will be maintained by the CCO and shared with the senior management and the CCC.
								</p>
								<p>
							...
							<li>
								...
								<p>
									Lifelink Health Providers, Inc. will treat any alleged violation of the Code Core Documents seriously, will review or investigate the allegation promptly and will take all appropriate corrective action. Where appropriate, it will also make a report to the federal or state government and make public disclosure.
								</p>
								<span>
									<ol>
										<li>
											...
											<p>
												Lifelink Health Providers, Inc. wants to know promptly any potential or suspected violation of the Code Documents.
											</p>
											<p>
										...
										<li>
											Reporting
											<p>
												Lifelink Health Providers, Inc. will promptly report the existence of misconduct to the appropriate federal and state authorities within a reasonable period, but not more than sixty (60) days after determining that there is credible evidence of a violation.
											</p>
											<p>
		...
		<br />
		<div class="row">
			<span style="text-align:center;"><b>CONFIDENTIALITY STATEMENT</b></span>
			<p>
		...
		<div class="row">
			...
			<p>
				As an employee of Lifelink Health Providers, Inc.Lifelink (hereinafter “the Provider”), and as a condition of my employment, I agree to the following:
			</p>
			<span>
				<ol>
					<li>
		...
		<br />
		<div class="row">
			<span style="text-align:center;"><b>CHILD ABUSE REPORTING STATEMENT</b></span>
			<page>
				<p>
