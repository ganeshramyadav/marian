...
<style>
	...
	<form method="post" class="saform" action="#">
		...
		<div class="row">
			<span >
				<p style="margin-left: 1em;">I,<span><input name="sa_name1" value="<?php echo $sa_info->sa_name1?>" class="form-control" style="display: inline;width: inherit;"/></span>an employee of Lifelink Health Providers, Inc. do hereby state that I will:</p>
			</span>
			<span>
