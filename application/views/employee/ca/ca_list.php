...
<h4><?php echo anchor('admin/ca/add_ca/'.$disciplinedetail->discipline_id, '<i class="fa fa-plus"></i> Add COMPETENCY ASSESSMENT -'.$disciplinedetail->discipline); ?></h4>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-print">
										<?php if($check == 'PE-AC'){
												...
												echo btn_edit('admin/ca/add_ca/'. $disciplinedetail->discipline_id.'/'.$item->uid.'/'. $item->id);
