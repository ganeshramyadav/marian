            ...
            <div class="container">
                ...
                if (!empty($genaral_info)) {
                    foreach ($genaral_info as $info) {
                        ...
                        <div class="head">
                            <h2>MarianHR<?php // echo $info->name ?></h2>
                        </div>
                        ...
                        <nav class="main-menu navbar navbar-collapse menu-bg" role="navigation">
                            ...
                            <div class="main-menu collapse navbar-collapse menu-bg" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
									...
									-->
				    <li class="<?php if(!empty($menu['competency'])){ echo $menu['competency'] == 1 ? 'active' : '';} ?>"><a href="<?php echo base_url() ?>employee/dashboard/all_competency">COMPETENCY ASSESSMENT</a></li>
