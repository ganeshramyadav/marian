    ...
    <div class="main_content">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="primary-link">Fathers Name</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($employee_details->date_of_birth=='0000-00-00'){ echo '-'; }else{ echo date('d M Y', strtotime($employee_details->date_of_birth));} ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
				...
				<a href="<?php echo base_url() ?>employee/dashboard/profile_edit" class="view-all-front"><i class="fa fa-edit"></i> <strong>Edit Details </strong></a>
			    </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h2 class="panel-title"><strong><?php echo 'Upcoming Birthday' ?> </strong>- <?php echo date("F"); ?></h2>
                        </div>               
                        <div class="panel-body event">
                            <ul class="leave_apps">
                                <?php
