<table border="1"  class="table table-hover table-striped" border-collapse="collapse">
					<thead>
						<tr>
							<th><div class="input-group">&nbsp;&nbsp;&nbsp;Job Title/Position:  <b>Speech Language Pathologist (SLP)</b></div></th>
					...
					<tbody>
						...
						<tr>
							<td>Completes initial history and evaluation visit, notifies physician and IDG of patient's needs and submits orders for physician approval.</td>
						...
						<tr>
							<td>Provides all speech language pathology services according to physician orders and IDG.</td>
						...
						<tr>
							<td>Informs the attending physician and other team members of changes in the patient's condition and needs.</td>
						...
						<tr>
							<td>Involves patient/family in updating of IDG plan of care.</td>
						...
						<tr>
							<td>Periodically presents an inservice to the staff members as assigned.</td>
