<table border="1"  class="table table-hover table-striped" border-collapse="collapse">
					<thead>
						<tr>
							<td><div class="input-group">&nbsp;&nbsp;&nbsp;Job Title/Position:  <b>Patient Care Volunteer</div></b></th>
					...
					<tbody>
						...
						<tr>
							<td>Provides assigned respite services to patient and/or family.</td>
						...
						<tr>
	                                                <td>Understands and implements appropriate interventions for death and dying.</td>
						...
						<tr>
							<td>Communicates at the appropriate level with each patient/family.</td>
						...
						<tr>
							<td>Consult with team members for issues relating to the patient/family plan of care.</td>
