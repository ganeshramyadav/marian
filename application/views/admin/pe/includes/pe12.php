<table border="1"  class="table table-hover table-striped" border-collapse="collapse">
					...
					<tbody>
						...
						<tr>
							<td>Documents all patient/family services provided as required by Hospice policy; works with the family.</td>
						...
						<tr>
							<td>Provides input into revision and implementation of Hospice policies and procedures as requested.</td>
						...
						<tr>
							<td>Completes documentation and paperwork in a timely manner as per Hospice policy; prepares clinical and progress notes.</td>
						...
						<tr>
							<td>Acts as consultant to other Hospice personnel.</td>
						...
						<tr>
							<td>Exhibits Hospice philosophy in all job related roles</td>
						...
						<tr>
							<td>Complies with Hospice infection control policies and procedures.</td>
