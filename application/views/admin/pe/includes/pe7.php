<table border="1"  class="table table-hover table-striped" border-collapse="collapse">
					<thead>
						<tr>
							<th><div class="input-group">&nbsp;&nbsp;&nbsp;Job Title/Position:  <b>Physical Therapist (PT)</b></div></th>
					...
					<tbody>
						...
						<tr>
							<td>Instructs caregiver in use of good body mechanics for turning and lifting patients.</td>
						...
						<tr>
							<td>Consults with family and Home Health personnel.</td>
						...
						<tr>
							<td>Provides all physical therapy services according to physician orders and IDG care plan.</td>
						...
						<tr>
							<td>Informs patient/family of the physical therapy portion of the plan of care.</td>
						...
						<tr>
							<td>Performs home safety assessments.</td>
						...
						<tr>
							<td>Interacts with other health care providers for coordination of patient care.</td>
						...
						<tr>
							<td>Directs and supervises performance of LPTA.</td>
						...
						<tr>
							<td>Performs supervisory visits on each patient seen by the LPTA and documents supervisory visit in medical records.</td>
						...
						<tr>
							<td>Teaches patient/family in use of adaptive equipment.</td>
						...
						<tr>
							<td>Attends staff meetings and participates in IDG care conferences as scheduled.</td>
						...
						<tr>
							<td>Prepares and submits clinical and progress notes in a timely manner as outlined in Home Health policy.</td>
						...
						<tr>
							<td>Immediately reports to RN/Director any patient incidents/variances or complaints.</td>
