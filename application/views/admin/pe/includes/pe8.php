<table border="1"  class="table table-hover table-striped" border-collapse="collapse">
					<thead>
						<tr>
							<th><div class="input-group">&nbsp;&nbsp;&nbsp;Job Title/Position:  <b>Licensed Physical Therapy Assistant (LPTA)</b></div></th>
					...
					<tbody>
						...
						<tr>
							<td>Provides all physical therapy services according to physician orders, IDG and plan of care established by the PT for therapy services.</td>
						...
						<tr>
							<td>Performs services planned, delegated and supervised by the PT.</td>
						...
						<tr>
							<td>Assists in preparing clinical and progress notes.</td>
						...
						<tr>
							<td>Participates in educating the patient and family.</td>
						...
						<tr>
							<td>Informs the PT, IDG and other team members of changes in the patient's condition and needs.</td>
						...
						<tr>
							<td>Instructs patient/families in use of adaptive equipment.</td>
						...
						<tr>
							<td>Instructs caregivers in use of good body mechanics for turning and lifting patients.</td>
						...
						<tr>
							<td>Coordinates the therapy aspects of patient care with the PT.</td>
						...
						<tr>
							<td>Consults with PT to determine whether therapy treatment plan should be continued, changed or terminated.</td>
						...
						<tr>
							<td>Attends staff meetings and participates in IDG patient care conferences as scheduled.</td>
						...
						<tr>
							<td>Completes and submits progress notes and paperwork in a timely manner per Home Health policy.</td>
						...
						<tr>
							<td>Immediately reports to PT/Manager of Patient Services/Director any patient incidents/variances or complaints.</td>
						...
						<tr>
							<td>Reports all incomplete work assignments to PT.</td>
...
<div class="row">
 <div class="col-sm-6">
  <div class="">
   ...
   <div class="input-group">
   <textarea name="targetedgoals" ng-model="p.targetedgoals">{{ p.targetedgoals }}</textarea>
   </div>
  </div>
 </div>
</div>
