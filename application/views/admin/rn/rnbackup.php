            ...
            <div class="panel panel-info">
                   ...
                   <div class="panel-body ">
                      ...
                      <div class="">
                        <label class="control-label" >Date Of Birth <span class="required"> *</span></label>
                         <div class="input-group">
                             <input type="text" name="date_of_birth" ng-model="q.date_of_birth"  class="form-control datepicker" data-format="yyy-mm-dd">
                    ...
                    <div class="">
                        ...
                        <select name="nationality" ng-model="q.nationality" class="form-control col-sm-5" >
                            <option value="" >Select Language</option> 
                            <?php foreach ($all_country as $v_country) : ?>
                                <option value="<?php echo $v_country->idCountry ?>" <?php
                                if (!empty($rn_info->nationality)) {
                                    echo $v_country->idCountry == $rn_info->nationality ? 'selected' : '';
                                }
                                ?>><?php echo 'American'; ?></option>
                                    <?php endforeach; ?>
                        </select> 
                    </div>
					 ...
					 <div class="">
						...
						?>><?php echo $v_county->name ?></option>
							<?php endforeach; ?>
	                                        ...
	                                        <select name="service_city" ng-model="q.service_city"  class="form-control col-sm-5" id="city-list" onChange="getCityGoogleMap();">
						...
						if (!empty($rn_info->city_id)) {
							echo $v_city->id == $rn_info->service_city ? 'selected' : '';
...
<script type="text/javascript">
  debugger;
  var latitude = <? echo $service_map_lat; ?>;
  var longitude = <? echo $service_map_lng; ?>;
  ...
  $.ajax({
	...
	debugger;
	   ...
	   initialize(lat, lng);
         ...
         <div class="col-sm-6" style="float:right;"><!-- ************************ Employee Documents Start ******************************* -->
            <div class="panel panel-info">
                <div class="panel-heading">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<?php if (!empty($rn_info->resumes)): ?>
									<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Select file</span>
										...
										<input type="hidden" name="resumes" ng-model="q.resume" value="<?php echo $rn_info->resumes ?>">
										<input type="file" name="resumes" ng-model="q.resume" >
									</span>                                    
							...
							<div id="msg_pdf" style="color: #e11221"></div>
                               ...
                               <div class="">
		                        <label class="control-label" >Job Description</label>
                                        <select name="job_id" ng-model="q.job_id"   class="form-control col-sm-5" >
		                            <option value="" ></option>
		                  ...
		                  <div class="">
		                            ...
		                            <div class="input-group">
		                             <input type="text" name="date_of_interview"  ng-model="q.date_of_interview"  value="" class="form-control datepicker" data-format="yyy-mm-dd">
		                             <div class="input-group-addon">
		                                <a href="#"><i class="entypo-calendar"></i></a>
		                             </div>
                                     </div> 
		                   ...
		                   <div class="">
		                       <label class="control-label" >Official Status</label>
                        ...
                        <div class="col-sm-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                               ...
                               <a class="btn btn-default btn-file" href="<?php echo base_url() . $rn_info->i9_tax; ?>" target="_blank" >Print</a> 
                                ...
                                <?php else: ?>
                                <a class="btn btn-default btn-file" href="http://elumba.com/hrm2/img/uploads/i-9.pdf" target="_blank" >Print</a>
				  ...
				  <div class="form-group">
                        ...
                        <div class="col-sm-8">
                         ...
                         <a class="btn btn-default btn-file" href="<?php echo base_url() . $rn_info->state_of_ack; ?>" target="_blank" >Print</a> 
                                ...
                                <?php else: ?>
                                    <a class="btn btn-default btn-file" href="http://elumba.com/hrm2/img/uploads/Remove_code_from_rn.docx" target="_blank" >Print</a>
                                    <span class="btn btn-default btn-file"><span class="fileinput-new" >Upload file</span>
                                        <span class="fileinput-exists" >Change</span>                                            
                                        <input type="file" name="state_of_ack" ng-model="q.state_of_ack"  >
                                    </span> 
