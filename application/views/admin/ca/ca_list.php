...
<h4><?php echo anchor('admin/ca/add_ca/'.$disciplinedetail->discipline_id.'/'.$time_interval, '<i class="fa fa-plus"></i> Add COMPETENCY ASSESSMENT -'.$disciplinedetail->discipline); ?></h4>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <strong>COMPETENCY ASSESSMENT List</strong>
                ...
                <table class="table table-bordered table-hover" id="dataTables-example">
                    <thead>
                        <tr>
						    <th class="col-sm-1">CA Id</th>
                            <th class="col-sm-1">date_of_employment</th>
                            <th class="col-sm-1">date_of_completion</th>
                    ...
                    <tbody>  
                        ...
                        <?php if (!empty($users)): foreach ($users as $item) : ?>        
                                <tr>
                                    ...
                                    <td><?php echo $item->date_of_employment;?></td>
                                    <td><?php echo $item->date_of_completion; ?></td>
                                    <td><?php echo $item->firstname." ".$item->lastname; ?></td>
									
                                                            
                                    <!--<td class="hidden-print"><?php echo btn_view('admin/ca/view_ca/' . $item->id); ?></td>-->
                                    <td class="hidden-print"><?php echo btn_view('admin/ca/view_ca/'. $disciplinedetail->discipline_id.'/'.$item->uid.'/' . $item->id); ?></td>
                                    <td class="hidden-print">
										<?php if($check == 'PE-AC'){
												echo btn_edit('admin/lvn/add_acpe/' . $item->id);
												echo btn_delete('admin/rn/pe_delete/' . $item->id);
											}else{
												echo btn_edit('admin/ca/add_ca/'. $disciplinedetail->discipline_id.'/'.$time_interval.'/'.$item->uid.'/'. $item->id);
												echo btn_delete('admin/ca/ca_delete/' . $item->id);
											}
										?>
                                    </td>   
                                </tr>
