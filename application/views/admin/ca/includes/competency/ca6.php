...
<table border="1"  class="table table-hover table-striped">
	...
	<tbody>
		<tr>
			<td>T, P, R, BP: reading & recording</td>
			<td> 
		...
		<tr>
			<td>Safe transfer techniques</td>
			<td> 
		...
		<tr>
			<td>Complies with infection control: policies & procedures</td>
			<td> 
		...
		<tr>
			<td>Observing & reporting changes in pt condition & care furnished</td>
			<td> 
		...
		<tr>
			<td>Documenting pt status & care furnished</td>
			<td> 
		...
		<tr>
			<td>Maintenance of clean, safe & healthy environment</td>
			<td> 
		...
		<tr>
			<td>Elements of body function & changes to report to supervisor</td>
			<td> 
		...
		<tr>
			<td>Recognition of emergencies</td>
			<td> 
		...
		<tr>
			<td>Physical, emotional & developmental needs & ways to work with patients</td>
			<td> 
		...
		<tr>
			<td>Creates successful interpersonal relationships with pt& family</td>
			<td> 
...
<br />
<div class="row">
	<h2>ANNUAL ONSITE COMPETENCY</h2>
	<br />
	<h3>Hospice Aide</h3>
</div>
<br />
<table border="1"  class="table table-hover table-striped">
	...
	<tbody>
		<tr>
			<td>Reporting changes in patient condition</td>
		...
		<tr>
			<td>Creates successful interpersonal relationships with patient & families</td>
		...
		<tr>
			<td>Follows plan of care for completion of tasks assigned by RN</td>
