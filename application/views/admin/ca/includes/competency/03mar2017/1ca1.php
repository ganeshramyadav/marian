                   ...
                   <tr>
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td><select name="row701" ng-model="p.row701" class="form-control col-sm-5" >
	                                    <option value="" >Select Choice...</option>
                                            <option value="yes" >yes</option>
	                                    <option value="no" >no</option>        
                                          </select></td>
                            <td><select name="row702" ng-model="p.row702" class="form-control col-sm-5" >
	                                    <option value="" >Select Choice...</option>
                                            <option value="yes" >yes</option>
	                                    <option value="no" >no</option>        
                                          </select></td>
                            ...
                            <td>&nbsp;</td>
                            <td><input type="text" name="row703" ng-model="p.row703" value="" class="form-control"></td>
                            <td><input type="text" name="row704" ng-model="p.row704" value="" class="form-control"></td>
                         </tr>
...
<tr>
                            <td><select name="row1201" ng-model="p.row1201" class="form-control col-sm-5" >
	                                    <option value="" >Select Choice...</option>
                                            <option value="yes" >yes</option>
	                                    <option value="no" >no</option>        
                                          </select></td>
...
<tr>
                            ...
                            <td >&nbsp;</td>
                            <td><input type="text" name="row4703" ng-model="p.row4703" value="" class="form-control"></td>
                            <td><input type="text" name="row4704" ng-model="p.row4704" value="" class="form-control"></td>
                         </tr>
...
<tr>
                            <td><select name="row5301" ng-model="p.row5301" class="form-control col-sm-5" >
	                                    <option value="" >Select Choice...</option>
                                            <option value="yes" >yes</option>
	                                    <option value="no" >no</option>        
                                          </select></td>
...
<tr>
                            <td><select name="row5501" ng-model="p.row5501"  class="form-control col-sm-5" >
	                                    <option value="" >Select Choice...</option>
                                            <option value="yes" >yes</option>
	                                    <option value="no" >no</option>        
                                          </select></td>
...
<tr>
                            ...
                            <td class="text-center">*</td>
                            <td><input type="text" name="row9003" ng-model="p.row9003" value="" class="form-control"></td>
                            <td><input type="text" name="row9004" ng-model="p.row9004" value="" class="form-control"></td>
                         </tr>
