...
<table border="1"  class="table table-hover table-striped">
	...
	<tbody>
		<tr>
			<td>Provides initial comprehensive psychosocial and bereavement assessments</td>
			<td> 
		...
		<tr>
			<td>Ongoing counseling related to issues of death and dying</td>
			<td> 
		...
		<tr>
			<td>Evaluates home/family situation</td>
			<td> 
		...
		<tr>
			<td>Provides short term crisis intervention</td>
			<td> 
		...
		<tr>
			<td>Promote community services & provide education</td>
			<td> 
		...
		<tr>
			<td>Provide advocacy, referral & linkage with community services</td>
			<td> 
		...
		<tr>
			<td>Counsel & assist with financial problems and entitlements</td>
			<td> 
		...
		<tr>
			<td>Provide goal-oriented intervention directed toward management of a terminal illness</td>
			<td> 
		...
		<tr>
			<td>Assist with strengthening the family support system</td>
			<td> 
		...
		<tr>
			<td>Assist with resolution of conflict related to illness</td>
			<td> 
		...
		<tr>
			<td>Identify & advocate for patients at risk for physical or mental abuse and/or neglect</td>
			<td> 
		...
		<tr>
			<td>Identify & evaluate patients at high risk for suicide</td>
			<td> 
		...
		<tr>
			<td>Identify & evaluate patients with inadequate food, medications and/or medical supplies</td>
			<td> 
		...
		<tr>
			<td>Assists in developing IDG care plan according to patient needs & physician orders</td>
			<td> 
