       ...
       -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="info-box">
                   ...
                   <!-- <div class="info-box-content">
                        <span class="info-box-text">Discipline Count</span>
                        <?php
                            if (!empty($discipline_data)) {
                                foreach($discipline_data as $disciplinedata) 
                                   echo '<span class="info-box-text">'.$disciplinedata.'</span>';
                            }
                            ?>
                    </div> -->
                </div>
        ...
        <div class="row">
              <div class="col-sm-7">      
                ...
                <div class="wrap-fpanel margin">                           
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo 'Upcoming Birthday' ?> - <?php echo date("F"); ?></h3>
                        </div>               
                       ...
                       <!-- Expire Credentials -->
                             <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo 'Expire Credentials' ?> - <?php echo date("F"); ?></h3>
                        </div>               
                        <div class="panel-body bithday">
                            <ul class="leave_apps">
                                                             
                                <?php if (!empty($expire)):for ($j = 0; $j < count($expire); $j++) : ?>
                                        <li> 
                                            <a href="<?php echo base_url() ?>admin/employee/view_employee/">
                                                <h5>
                                                    <div class="pull-left">
                                                        <img class="img-circle" src="">
                                                    </div>
                                                    <span><?php echo $expire[$j][1]; ?></span>
                                                    <small class="apps_category" style="color:red">(Today)</small>
                                                    <p class="leave_para"><?php
                                                        echo $expire[$j][0];
                                                        ?></p>
            ...
            <div class="col-md-5 wrap-fpanel">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading with-border">
                        <h3 class="panel-title">User Based On Discipline</h3>                       
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            if (!empty($discipline_data)) {
                                foreach($discipline_data as $disciplinedata) 
                                   echo '<li class="info-box-text">'.$disciplinedata.'</li>';
                            }
                            ?>
                                </p>
                                 </ul>
              ...
              <!--  <div class="panel panel-default">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Pending Applications<span class="pull-right text-white"><a href="<?php echo base_url() ?>admin/application_list/" class=" view-all-front">View All</a></span></h3>
                    </div>               
...
?>
   ...
   <script>
    ...
    <?php foreach($expire as $key => $val){ ?>
       	   pausecontent.push(<?php echo json_encode($val); ?>);
    <?php } ?>
	  
	   	debugger;   
	     $.ajax({ 
	url: '<?php echo base_url(); ?>admin/dashboard/checkexpirydocuments',
	data : { result : JSON.stringify(pausecontent)},
	type:'POST',
