...
<div class="row">
	 ...
	 <!--<input type="text" name="discipline" value="<?php echo $discipline ?>" class="form-control">-->
         ...
         <div class="col-sm-6">
            <div class="panel panel-info">
                   ...
                   <div class="panel-body ">
                       ...
                       <div class="">
                        ...
                        <input id="user_name" type="text" name="user_name" ng-model="q.user_name" class="form-control">
                      ...
                      <div class="">
                        <label class="control-label" >Date Of Birth <span class="required"> *</span></label>
                         <div class="input-group">
                             <input type="text" name="date_of_birth" ng-model="q.date_of_birth"  class="form-control datepicker" data-date-format="mm/dd/yyyy" style="z-index:0;">
			...
			<select name="nationality[]" id="language-spoken" ng-model="q.nationality" multiple="multiple" class="form-control col-sm-5" >
				...
				<div class="input-group"> 
				        <div id="esign" style="float:left;width:315px;height:100px;border: black 1px solid;"></div>
				</div>
			    </div>
					<input type="button" id="resetesign" value="Reset">
						<input type="button" id="esignsrc" value="Upload Sign">
                                    <input type="hidden" id="esignature" name="signature" ng-model="q.signature" value="<?php echo $rn_info->signature;?>">
				     <img src="<?php
                                if (!empty($rn_info->signature)) {
                                    echo $rn_info->signature;
                                }
...
<!--
                            <label for="field-1" class="control-label"><?php echo 'Upload Signature' ?> <span class="required">*</span></label>
                            <div class="input-group">     
                                <input type="hidden" name="oldsign_path" ng-model="q.oldsign_path" value="<?php
                                if (!empty($rn_info->signature_a_path)) {
                                    echo $rn_info->signature_a_path;
                                }
                                ?>">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 100px; height: 50px;">
...
function getState() { 
 ...
 $.ajax({
  type: "POST",
  dataType: 'json',
  url: "<?php echo base_url(); ?>admin/discipline/location_list/",
  data:'id='+val,
...
function getCityGoogleMap(){
  ...
  $.ajax({
	   ...
	   initialize(lat, lng);
				...
				?>" class="form-control" maxlength="14" placeholder="(XXX) XXX-XXXX">
					...
					<div class="">
						...
						<input type="text" id="no" name="no" ng-model="q.no" value="<?php
				if (!empty($rn_info->no)) {
					echo $rn_info->no;
				}
				?>" class="form-control" maxlength="14" placeholder="(XXX) XXX-XXXX">
				...
				?>" class="form-control" maxlength="11" placeholder="XXX-XX-XXXX">
                                    ...
                                    <div class="">
                                       <label class="control-label" >Email <span class="required"> *</span></label>
                                        <input type="text" name="email" ng-model="q.email" value="<?php echo $rn_info->email;?>"  class="form-control">
                                    </div>
			       </div>
				 ...
				 <!-- Interview Date -->
                              ...
                              <div class="">
		                            ...
		                            <div class="input-group">
		                             ...
		                             <input type="text" name="date_of_interview" ng-model="q.date_of_interview" class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->date_of_interview?>" style="z-index:0;">
		                             <div class="input-group-addon">
		                                <a href="#"><i class="entypo-calendar"></i></a>
		                             </div>
                                     </div> 
				  ...
				  <!-- Official status -->
				   ...
				   <!--   Date of Hire -->	  
				       <div class="">
		                            ...
		                            <div class="input-group">
		 <input type="text" name="date_of_hire"  ng-model="q.date_of_hire" class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->date_of_hire?>" style="z-index:0;">
		                             <div class="input-group-addon">
		                                <a href="#"><i class="entypo-calendar"></i></a>
		                             </div>
                                     </div> 
								...
								<div class="col-sm-8">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<?php if (!empty($rn_info->resumes)): ?>
											<a class="btn btn-default btn-file" href="<?php echo base_url() . $rn_info->resumes; ?>" target="_blank" >Print</a>
	...
	<!-- job Description -->
              <?php if (!empty($rn_info->uid)){
			        if($discipline_id != 17 && $discipline_id != 18) {
			?>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<div class="fileinput fileinput-new" data-provides="fileinput">
					...
					<?php if (!empty($rn_info->uid)): ?>
						<a class="btn btn-default btn-file" href="<?php echo base_url() . 'admin/discipline/makejobdesc_pdf/'.$rn_info->uid; ?>" target="_blank" >Print</a> 
					...
					<?php else: ?>
						<a class="btn btn-default btn-file" href="<?php echo base_url() .'img/uploads/jobdescription/'.$discipline_id.'/'.$discipline_id.'.docx'?>" target="_blank">Print</a>
...
<!-- <script src="<?php echo base_url(); ?>asset/js/jquery.maskedinput-1.3.min.js" type="text/javascript"></script> -->
 <!-- <script src="<?php echo base_url(); ?>asset/js/phonevalidation.js" type="text/javascript"></script>  -->
  ...
  debugger;
	...
	//		official_status : "required" ,
	  ...
	  $.ajax( {
      url: "<?php echo base_url(); ?>admin/discipline/save_discipline/",
      type: 'POST',
    ...
    uid=data;
	  ...
	  // $("#employee-form1").show();
          // $("#employee-form").hide();
           ...
           $('#loadingmessage').show();
				 $.ajax( {
      url: "<?php echo base_url(); ?>admin/discipline/save_discipline/"+uid,
      type: 'POST',
      data: new FormData( form ),
      processData: false,
      contentType: false,
