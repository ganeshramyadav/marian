 ...
 ?>
	<div class="row" style="padding-top:5em;">
			...
			<div class="form-group">
				...
				<div class="fileinput fileinput-new" data-provides="fileinput">
					...
					<?php if (!empty($rn_info->personnel_action_form)): ?>
						<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Upload file</span>
							<span class="fileinput-exists" style="display: block">Change</span>
			                     <input type="hidden" name="personnel_action_form" ng-model="q.personnel_action_formpersonnel_action_form" value="<?php echo $rn_info->personnel_action_form?>">
		...
		<div class="col-sm-6">
			...
			<!-- SSN File Uploads -->
			<div class="form-group" style="margin-bottom: auto;">
				<label for="field-1" class="col-sm-4 control-label">SSN</label>
				<input type="hidden" name="ssndoc_path" ng-model="q.ssndoc_path" value="<?php
				if (!empty($rn_info->ssndoc_path)) {
					echo $rn_info->ssndoc_path;
				}
				?>">
				<div class="col-sm-8">
					<div class="fileinput fileinput-new" data-provides="fileinput">
					   
						<?php if (!empty($rn_info->ssndoc)): ?>
							<a class="btn btn-default btn-file" href="<?php echo base_url() . $rn_info->ssndoc; ?>" target="_blank" >Print</a> 
							<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Upload file</span>
								<span class="fileinput-exists" style="display: block">Change</span>
							<input type="hidden" name="ssndoc" ng-model="q.ssndoc" value="<?php echo $rn_info->ssndoc?>">
								<input type="file" name="ssndoc" ng-model="q.ssndoc" >
							</span>
			...
			<!-- Others First  -->
			<div class="form-group" style="margin-bottom: auto;">
				<label for="field-1" class="col-sm-4 control-label">Others1</label>
			...
			<!-- Others second -->
			<div class="form-group" style="margin-bottom: auto;">
				<label for="field-1" class="col-sm-4 control-label">Others2</label>
			...
			<!-- Others third -->
			<div class="form-group">
				<label for="field-1" class="col-sm-4 control-label">Others3</label>
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<div class="input-group">
							<input type="text" name="physical_examination_expiry_date" data-date-start-view="0" class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->physical_examination_expiry_date;?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="TB_test_expiry_date" ng-model="q.TB_test_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->TB_test_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
				...
				<div class="col-sm-2" >
					<div class="fileinput fileinput-new" data-provides="fileinput">
						...
						<?php if (!empty($rn_info->TB_Questionnaire_date)): ?>
							<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Upload file</span>
								<span class="fileinput-exists" style="display: block">Change</span>
								<input type="hidden" name="TB_Questionnaire_date" ng-model="q.TB_Questionnaire_date" value="<?php echo $rn_info->TB_Questionnaire_date?>">
								<input type="file" name="TB_Questionnaire_date" ng-model="q.TB_Questionnaire_date" >
							</span>
				...
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-6">
							<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
							<div class="input-group">
								<input type="text" name="TB_questionnaire_expiry_date"  data-date-start-date="0" class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->TB_questionnaire_expiry_date;?>">
								<div class="input-group-addon">
									<a href="#"><i class="entypo-calendar"></i></a>
								</div>
							</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="chest_XRay_results_expiry_date" ng-model="q.chest_XRay_results_expiry_date" data-date-start-date="0" class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->chest_XRay_results_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
				...
				<div class="col-sm-2" >
					<div class="fileinput fileinput-new" data-provides="fileinput">
						...
						<?php if (!empty($rn_info->Influenza_Immunization)): ?>
							<span class="btn btn-default btn-file"><span class="fileinput-new" style="display: none" >Upload file</span>
								<span class="fileinput-exists" style="display: block">Change</span>
								<input type="hidden" name="Influenza_Immunization" ng-model="q.Influenza_Immunization" value="<?php echo $rn_info->Influenza_Immunization?>">
								<input type="file" name="Influenza_Immunization" ng-model="q.Influenza_Immunization" >
							</span>
				...
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-6">
							<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
							<div class="input-group">
								<input type="text" name="influenza_immunization_expiry_date" ng-model="q.influenza_immunization_expiry_date"  class="form-control datepicker" data-date-format="mm/dd/yyyy" data-date-start-date="0" value="<?php echo $rn_info->influenza_immunization_expiry_date;?>">
								<div class="input-group-addon">
									<a href="#"><i class="entypo-calendar"></i></a>
								</div>
							</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="ninety_day_performance_evaluation_expiry_date" ng-model="q.ninety_day_performance_evaluation_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->ninety_day_performance_evaluation_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="initial_competency_assessment_expiry_date" ng-model="q.initial_competency_assessment_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->initial_competency_assessment_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="automobile_insurance_expiry_date" ng-model="q.automobile_insurance_expiry_date"  class="form-control datepicker" data-date-format="mm/dd/yyyy" data-date-start-date="0" value="<?php echo $rn_info->automobile_insurance_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="CPR_card_expiry_date" ng-model="q.CPR_card_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->CPR_card_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="drivers_license_expiry_date" ng-model="q.drivers_license_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->drivers_license_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="prof_liability_Insurance_expiry_date" ng-model="q.prof_liability_Insurance_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->prof_liability_Insurance_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>
						<div class="input-group">
							<input type="text" name="professional_license_expiry_date" ng-model="q.professional_license_expiry_date"  class="form-control datepicker" data-date-start-date="0" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->professional_license_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
						</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="row">
						...
						<!--<label class="col-sm-4 control-label" >Expiry Date<span class="required"> *</span></label>-->
						<div class="input-group">
							<!--<input type="text" name="professional_license_verification_expiry_date" ng-model="q.professional_license_verification_expiry_date" data-date-start-date="0"  class="form-control datepicker" data-date-format="mm/dd/yyyy" value="<?php echo $rn_info->professional_license_verification_expiry_date;?>">
							<div class="input-group-addon">
								<a href="#"><i class="entypo-calendar"></i></a>
							</div>
							-->
