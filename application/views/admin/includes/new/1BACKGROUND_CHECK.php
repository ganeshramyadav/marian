	<div class="container" style="width:100%; padding-left: 2em; padding-right: 2em;">
		...
		<div class="section-header row">
			...
			<h1>Lifelink Hospice and Palliative Care</h1>
	...
	<form method="post" action="#">
			...
			<div class="row" style="text-align: justify;">
				<div >
					<span>
						<p>
							In the interest of maintaining the safety and security of our customers, employees and property, <b>Lifelink Hospice and Palliative Care.</b>
							...
							The background check company, ADP Screening and Selection Services, will prepare the background report for <b>Lifelink Hospice and Palliative Care.</b>
							...
							You may request more information about the nature and scope of an investigative consumer report, if any, by calling <b>Lifelink Hospice
							and Palliative Care. at 818-453-3371</b>. A summary of your rights under the Fair Credit Reporting Act is also being provided to you with
							this form.
						</p>
					</span>
					<br />
					...
					<span>
						<p>
							After carefully reading this Background Check Disclosure and Authorization form, I authorize <b>Lifelink Hospice and Palliative Care.</b> to order my background report, including investigative consumer reports. I understand that <b>Lifelink Hospice and Palliative Care.</b> may rely on this authorization to order additional background reports, including investigative consumer reports, during my employment without asking me for my authorization again as allowed by law.
						</p><p>
			...
			<div class="row">
				<div class="row">
					...
					<div class="col-sm-3">
					<input id="first-name" class="form-control" value="<?php echo $rn_info->first_name?>" style="display: inline;"/>
					</div>
					<div class="col-sm-3">
						<label for="last-name">Last Name: </label>
					</div>
					<div class="col-sm-3">
					<input id="last-name" class="form-control" value="<?php echo $rn_info->last_name?>" style="display: inline;"/>
					</div>
				</div>
				<p></p>
				<div class="row">
					...
					<div class="col-sm-3">
						<input id="years-used" class="form-control" style="display: inline;"/>
					</div>
					<div class="col-sm-3">
						<label for="social-security-no">Social Security Number: </label>
					</div>
					<div class="col-sm-3">
						<input id="social-security-no" class="form-control" style="display: inline;"/>
					</div>
				</div>
				<p></p>
				<div class="row">
					...
					<div class="col-sm-2">
						<input id="driver-license" class="form-control" style="display: inline;"/>
					</div>
					<div class="col-sm-2">
						<label for="state">State: </label>
					</div>
					<div class="col-sm-2">
						<input id="state" class="form-control" style="display: inline;"/>
					</div>
					<div class="col-sm-2">
						<label for="dob">Date of Birth: </label>
					</div>
					<div class="col-sm-2">
						<input id="dob" type="date" class="form-control" style="display: inline;"/>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<input id="present-address" class="form-control" value="<?php echo $rn_info->present_address?>" style="display: inline; width: 50%;"/>
				</div>
				<p></p>
				<div class="row">
					<div class="col-sm-4">
						<label for="city">City: </label>
						<input id="city" class="form-control" style="display: inline; width: initial;"/>
					</div>
					<div class="col-sm-4">
						<label for="state">State: </label>
						<input id="state" class="form-control" style="display: inline; width: initial;"/>
					</div>
					<div class="col-sm-4">
						<label for="zip">ZIP: </label>
						<input id="zip" class="form-control" style="display: inline; width: initial;"/>
					</div>
				</div>
				<br />
				<div class="row">
					<label for="street-address">Prior Street Address: </label>
					<input id="street-address" class="form-control" style="display: inline; width: 50%;"/>
					...
					<div class="row">
						<div class="col-sm-4">
							...
							<input id="last-name" type="date" class="form-control" style="display: inline; width: 50%;"/>
						</div>
						<p></p>
						<div class="col-sm-4">
			...
			<div class="row">
				<div class="row">
					<div class="col-sm-8">
						<label for="signature" style="float: left;">Signature</label>
				...
				<div class="row">
					...
					<input id="last-name" type="checkbox" class="form-control" style="display: inline; width: inherit; height: inherit; margin-top: 0.5em;"/>
				</div>
			</div>
			<br/ >
			<div class="row">
