			...
			<div class="container" style="border: 1px solid black; width: inherit;">
				...
				<div class="row" style="border: 1px solid black; width: inherit;">
					...
					<div style="padding-left:19em;">
						<label for="last-name" style="float:left;">Yes</label><input type="radio" name="person-status" id="citizen" value="citizen" style="float: left;">
						<label for="last-name" style="float:left;">No</label><input type="radio" name="person-status" id="citizen" value="citizen" style="float: left;">
					</div>
				</div>
				<div class="row" style="border: 1px solid black; width: inherit;">
					...
					<table class="responsive-stacked-table" style="width: 100%;">
						...
						<tbody>
							<tr style="">
								...
								<td><input id="last-name" class="form-control" style="display: inline;"/> </td>
								<td><input id="last-name" class="form-control" style="display: inline;"/> </td>
								<td><input id="last-name" class="form-control" style="display: inline;"/> </td>
							</tr>
							<tr>
				...
				<div class="row" style="border: 1px solid black; width: inherit;">
					...
					<div class="col-md-6">
						...
						<input id="last-name" class="form-control" style="display: inline; width: inherit; margin-left: 4em;"/>
						<p></p>
					</div>
					<p></p>
				</div>
				...
				<div class="row" style="border: 1px solid black; width: inherit;">
					...
					<div class="col-md-6">
						...
						<input id="last-name" type="date" class="form-control" style="display: inline; width: inherit; margin-left: 4em;"/>
						<p></p>						
					</div>
					<p></p>
				</div>
