<div class="container" style="width: 100%;">
    ...
    <form method="post" class="i9form" action="#" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 19px;">
      ...
      <div class="form-box container" style="border-right: 1px solid black;border-bottom: 1px solid black;margin-bottom: 1ex; width: 100%;">
        <div class="row">
          <div class="col-sm-8" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_last_name" value="<?php echo $i9_info->i9_last_name?>" />
              </div>

              <div class="col-sm-4">
                <label for="first-name">First Name <em>(Given Name)</em></label>
                <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_first_name" value="<?php echo $i9_info->i9_first_name?>" />
              </div>

              <div class="col-sm-4">
                <label for="middle-initial">Middle Initial</label>
                <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_mid_name" value="<?php echo $i9_info->i9_mid_name?>" />
              </div>
          ...
          <div class="col-sm-4" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_other_name" value="<?php echo $i9_info->i9_other_name?>" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-4" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_address" value="<?php echo $i9_info->i9_address?>" />
          </div>
          ...
          <div class="col-sm-2" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_apt_no" value="<?php echo $i9_info->i9_apt_no?>" />
          </div>
          ...
          <div class="col-sm-3" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_city" value="<?php echo $i9_info->i9_city?>" />
          </div>

          <div class="col-sm-1" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            <label for="state">State</label>
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_state" value="<?php echo $i9_info->i9_state?>" />
          </div>

          <div class="col-sm-2" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            <label for="zip-code">Zip Code</label>
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_zip" value="<?php echo $i9_info->i9_zip?>" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-3" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input type="date" class="form-control" value="<?php echo $rn_info->date_of_birth?>" style="font-weight: bold; font-size: 14pt;"/>
          </div>

          <div class="col-sm-3" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            <label for="ssn">U.S. Social Security Number</label>
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_ssn" value="<?php echo $i9_info->i9_ssn?>" />
          </div>

          <div class="col-sm-4" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            <label for="email">E-mail Address</label>
            <input type="email" class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_email" value="<?php echo $i9_info->i9_email?>" />
          </div>

          <div class="col-sm-2" style="border-top: 1px solid black;border-left: 1px solid black;padding-bottom: .5em;">
            <label for="telephone">Telephone Number</label>
            <input type="tel" class="form-control"style="font-weight: bold; font-size: 14pt;" name="i9_tel" value="<?php echo $i9_info->i9_tel?>" />
          </div>
        </div>
      </div>
      ...
      <ul class="list-unstyled checkbox-list">
        ...
        <li><input type="radio" name="person-status" id="permanent-resident" value="permanent-resident" style="display: inline; width: 1em; height: 1em;"/>
          ...
          <input class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_uscis" value="<?php echo $i9_info->i9_uscis?>" /></li>
        ...
        <li><input type="radio" name="person-status" id="alien-authorized" value="alien-authorized" style="display: inline; width: 1em; height: 1em;"/>
          ...
          <input type="date" class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_expiration" value="<?php echo $i9_info->i9_expiration?>" />. Some aliens may write "N/A" in this field. <em>(See instructions)</em>
          ...
          <ol>
            ...
            <li><label for="alien-authorized-number">Alien Registration Number/USCIS Number:</label>
              <input  class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_uscis1" value="<?php echo $i9_info->i9_uscis1?>" />
            ...
            <li>
              ...
              <input class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_admission_no" value="<?php echo $i9_info->i9_admission_no?>" />
              ...
              <input class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_fpn" value="<?php echo $i9_info->i9_fpn?>" />
              <br>

              <label for="foreign-country">Country of Issuance:</label>
              <input class="form-control input-control" style="display: inline; width: auto; padding: 0 .5ex;" name="i9_coi" value="<?php echo $i9_info->i9_coi?>" />
      ...
      <div class="form-box container" style="border-right: 1px solid black;border-bottom: 1px solid black;border-top: 1px solid black;border-left: 1px solid black;margin-bottom: 1ex;width: 100%;">
        <div class="row">
          ...
          <div class="col-sm-4" style="/* border-top: 1px solid black; */border-left: 1px solid black;padding-bottom: .5em;">
            ...
            <input type="date" class="form-control" name="i9_sign_date" value="<?php echo $i9_info->i9_sign_date?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-box container" style="border-left: 1px solid black; border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; margin-bottom: 1ex;">
        <div class="row">
          <div class="col-sm-8" style="border-right: 1px solid black; padding-bottom: .5em;">
            <label for="preparer-signature" style="white-space: nowrap;font-size: .9em;display: block;">Signature of Preparer or
              Translator:</label>
            <input class="form-control" name="i9_first" value="<?php echo $i9_info->i9_first?>" />
          </div>

          <div class="col-sm-4">
            <label for="preparer-signature-date">Date
              <em>(mm/dd/yyyy)</em>:</label>
            <input type="date" class="form-control input-control" name="i9_sign_date1" value="<?php echo $i9_info->i9_sign_date1?>" />
          </div>
        </div>
        ...
        <div class="row" style="border-top: 1px solid black; border-bottom: 1px solid black;">
          <div class="col-sm-6" style="border-right: 1px solid black; padding-bottom: .5em;">
            ...
            <input class="form-control" style="font-weight: bold; font-size: 14pt;" name="i9_last_name1" value="<?php echo $i9_info->i9_last_name1?>" />
          </div>

          <div class="col-sm-6" style="padding-bottom: .5em;">
            <label for="preparer-first-name">First Name <em>(Given Name)</em></label>
            <input class="form-control" name="i9_first_name1" value="<?php echo $i9_info->i9_first_name1?>" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-5" style="border-right: 1px solid black; padding-bottom: .5em;">
            ...
            <input class="form-control" name="i9_address1" value="<?php echo $i9_info->i9_address1?>" />
          </div>
          ...
          <div class="col-sm-4" style="border-right: 1px solid black; padding-bottom: .5em;">
            ...
            <input class="form-control" name="i9_city1" value="<?php echo $i9_info->i9_city1?>" />
          </div>

          <div class="col-sm-1" style="border-right: 1px solid black; padding-bottom: .5em;">
            <label for="preparer-state">State</label>
            <input class="form-control" name="i9_state1" value="<?php echo $i9_info->i9_state1?>" />
          </div>

          <div class="col-sm-2">
            <label for="preparer-zip-code">Zip Code</label>
            <input class="form-control" name="i9_zip1" value="<?php echo $i9_info->i9_zip1?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-cell" style="    border: 1px solid black; margin: 1ex 0; padding: 1ex;">
        ...
        <input class="form-control input-control" style="width: 30em; display: inline;" name="i9_f_m_l_name" value="<?php echo $i9_info->i9_f_m_l_name?>" />
      </div>
...
.form-cell {
	...
	width: 100%;
      ...
      <p><label for="first-day"><strong>The employee's first day of employment
        ...
        <strong><input type="date" class="form-control input-control" name="i9_first_date" value="<?php echo $i9_info->i9_first_date?>" />
      ...
      <div class="form-box container">
        <div class="row">
          <div class="col-sm-5">
            ...
            <input class="form-control" name="i9_name11" value="<?php echo $i9_info->i9_name11?>" />
          </div>

          <div class="col-sm-2">
            <label for="employer-signature-date">Date (mm/dd/yyyy):</label>
            <input type="date" class="form-control input-control" name="i9_sign_date2" value="<?php echo $i9_info->i9_sign_date2?>" />
          </div>

          <div class="col-sm-5">
            <label for="employer-title">Title of Employer or Authorized
              Representative</label>
            <input class="form-control input-control" name="i9_title" value="<?php echo $i9_info->i9_title?>" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            ...
            <input class="form-control" name="i9_last_name2" value="<?php echo $i9_info->i9_last_name2?>" />
          </div>

          <div class="col-sm-3">
            <label for="employer-first-name">First Name <em>(Given Name)</em></label>
            <input class="form-control" name="i9_first_name2" value="<?php echo $i9_info->i9_first_name2?>" />
          </div>

          <div class="col-sm-6">
            <label for="employer-business-name">Employer's Business or
              Organization Name</label>
            <input class="form-control" name="i9_org_name" value="<?php echo $i9_info->i9_org_name?>" />
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <input class="form-control" name="i9_org_address" value="<?php echo $i9_info->i9_org_address?>" />
          </div>

          <div class="col-sm-3">
            <label for="employer-city-or-town">City or Town</label>
            <input class="form-control" name="i9_org_city" value="<?php echo $i9_info->i9_org_city?>" />
          </div>

          <div class="col-sm-1">
            <label for="employer-state">State</label>
            <input class="form-control" name="i9_org_state" value="<?php echo $i9_info->i9_org_state?>" />
          </div>

          <div class="col-sm-2">
            <label for="employer-zip-code">Zip Code</label>
            <input class="form-control" name="i9_org_zip" value="<?php echo $i9_info->i9_org_zip?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-box container">
        <div class="row">
          <div class="col-sm-8">
            ...
            <input class="form-control" name="i9_last_name3" value="<?php echo $i9_info->i9_last_name3?>" />
          </div>

          <div class="col-sm-4">
            <label for="rehire-date"><strong>B.</strong>
              Date of Rehire <em>(if applicable) (mm/dd/yyyy)</em></label>
            <input type="date" class="form-control" name="i9_rehire_date" value="<?php echo $i9_info->i9_rehire_date?>" />
          </div>
        </div>
      </div>
      ...
      <div class="form-box container">
        <div class="row">
          <div class="col-sm-4">
            ...
            <input id="document-title" class="form-control" name="i9_document_title" value="<?php echo $i9_info->i9_document_title?>"/>
          </div>

          <div class="col-sm-4">
            <label for="document-number">Document Number:</label>
            <input id="document-number" class="form-control" name="i9_document_number" value="<?php echo $i9_info->i9_document_number?>"/>
          </div>

          <div class="col-sm-4">
            <label for="expiration-date">Expiration Date
              <em>(if any) (mm/dd/yyyy)</em></label>
            <input type="date" class="form-control" name="i9_exp_date" value="<?php echo $i9_info->i9_exp_date?>" />
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-5">
            <label for="employer-signature2">Signature of Employer or Authorized
              Representative:</label>
            <input class="form-control" name="i9_first_name3" value="<?php echo $i9_info->i9_first_name3?>" />
          </div>

          <div class="col-sm-2">
            <label for="employer-signature-date">Date
              <em>(mm/dd/yyyy)</em>:</label>
            <input type="date" class="form-control" name="i9_sign_date3" value="<?php echo $i9_info->i9_sign_date3?>" />
          </div>

          <div class="col-sm-5">
            <label for="employer-name">Print Name of Employer or Authorized
              Representative:</label>
            <input class="form-control" name="i9_emp_name" value="<?php echo $i9_info->i9_emp_name?>" />
          </div>
        </div>
      </div>
...
function callfunc(){ 
	$('#i9_form').val(JSON.stringify($('form.i9form').serializeObject()));
	$("#myModali9").hide();
	return false;
}
</script>