                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">You have <?php
                                ...
                                ?> messages
                                <small><a href="<?php echo base_url() ?>super/mailbox/inbox">All Messages</a></small>
                            </li>
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    if (!empty($email_notification)):
                                        foreach ($email_notification as $v_email_info) :
                                            ?>
                                            <li><!-- start message -->
                                                <a href="<?php echo base_url() ?>super/mailbox/read_inbox_mail/<?php echo $v_email_info->inbox_id ?>">                                                
                                                    <h4>
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">You have <?php
                                ...
                                ?> Notice
                                <small><a href="<?php echo base_url() ?>super/notice/manage_notice">All Notice</a></small>
                            </li>
                            <li>
                                <!-- inner menu: contains the actual data -->
                                <ul class="menu">
                                    ...
                                    if (!empty($notice_notification)):
                                        foreach ($notice_notification as $v_notice_info) :
                                            ?>
                                            <li><!-- start message -->
                                                <a href="<?php echo base_url() ?>super/notice/notice_details/<?php echo $v_notice_info->notice_id ?>">                                                
                                                    <h4>
                    ...
                    <li class="dropdown messages-menu leave">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">You have <?php
                                ...
                                ?> Application <small><a  href="<?php echo base_url() ?>super/application_list">All Application</a></small></li>
                            <li>
                                <!-- inner menu: contains the actual data -->
                                <ul class="menu">
                                    <?php
                                    ...
                                    if (!empty($leave_notification)):
                                        foreach ($leave_notification as $v_leave_info) :
                                            ?>
                                            <li><!-- start message -->
                                                <a href="<?php echo base_url() ?>super//application_list/view_application/<?php echo $v_leave_info->application_list_id ?>">                                                
                                                    <div class="pull-left">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url() ?>super/settings/update_profile" class="btn btn-default btn-flat">Update Profile</a>
                                </div>
