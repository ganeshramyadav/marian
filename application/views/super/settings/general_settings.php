    ...
    <div class="col-sm-12 wrap-fpanel">
        <div class="panel panel-default" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="general_settings" enctype="multipart/form-data" onsubmit="return validation(this)" action="<?php echo base_url(); ?>super/settings/save_ginfo/<?php if (!empty($ginfo)) echo $ginfo->id_gsettings; ?>" method="post" class="form-horizontal form-groups-bordered">
...
<!--                                            <input type="file" name="logo" size="20" id="myImg" /></span>-->
    ...
    <!--                                        <input type="file" name="logo" size="20" id="logo"/>-->
                                        ...
                                        <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput"><?php echo $this->language->from_body()[1][26] ?></a>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="country_id" class="form-control col-sm-5" >
                                <option value="" ><?php echo $this->language->from_body()[1][24] ?> ...</option>
