...
<div class="row">    
    <form role="form" id="update_profile" action="<?php echo base_url(); ?>super/settings/profile_updated" method="post" class="form-horizontal form-groups-bordered">                        
    ...
    <form role="form" id="change_password" action="<?php echo base_url(); ?>super/settings/set_password" method="post" class="form-horizontal form-groups-bordered">                        
        <div class="col-sm-6 wrap-fpanel">
            <div class="panel panel-default" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="password" name="old_password" value="" class="form-control"  placeholder="Enter Your Old Password" onchange="super_check_current_password(this.value)"/>
