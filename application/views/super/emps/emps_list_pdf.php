...
<html>
    ...
    <body style="min-width: 100%; min-height: 100%; overflow: hidden; alignment-adjust: central;">
        ...
        <div style="width: 100%;">
            ...
            <br/>
			<?php
				foreach($all_rn_info as $info){
					$agecny_name = $info['admin_name'];
					$discipline_name = $info['discipline'];
				}
			...
			<div style="width: 100%; background-color: rgb(224, 224, 224); padding: 1px 0px 5px 15px;">                
                <table style="width: 100%;">                    
                    <tr style="font-size: 20px;  text-align: left">
                        <td style="padding: 10px;"> <?php echo "Agency Name	:	".$agecny_name; ?></td>
						
                    </tr>
					<tr style="font-size: 20px;  text-align: left">
                        <td style="padding: 10px;"> <?php echo "Designation Name	:	".$discipline_name; ?></td>
                    </tr>
                </table>
            </div>
			<br/>
            <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse;">
                <tr class="table_tr1">
					...
					<!--
					<td style="border: 1px solid black;">Agency Name</td>
					-->
					...
					<!--
					<td style="border: 1px solid black;">Created Date</td>
					-->
                ...
                <?php //if (!empty($all_employee_info)): foreach ($all_employee_info as $v_employee) : ?>
				 ...
				 <?php if (!empty($all_rn_info)): foreach ($all_rn_info as $rn_employee) : ?>
                        ...
                        <tr class="table_tr2">
                            <td><?php echo $key ?></td>
							<!--<td><?php echo $rn_employee['admin_name']; ?></td>-->
                            <td><?php echo $rn_employee['first_name']." ".$rn_employee['last_name']; ?></td>
							
							<!--<td><?php echo $rn_employee['discipline']; ?></td>-->
							<td><?php echo $rn_employee['email']; ?></td>

                            <td><?php echo $rn_employee['mobile']; ?></td>                                

                            <td><?php
                                        if ($rn_employee['status_id'] == 1) {
                                            echo '<span class="label label-success" style="color : #5cb85c">Active</span>';
                                        } else {
                                            echo '<span class="label label-danger" style="color : #d9534f">Deactive</span>';
                                        }
                                        ?></td>                                                            
                        </tr>
                        <?php
