            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <strong><?php echo "Employee List"; ?></strong>
                        <div class="pull-right hidden-print">                                                                      
                            <span id = "empsid"><?php // echo btn_pdf('super/emps/emps_list_pdf'); ?></span>
				...
				<div class="">
					<label class="control-label" ><?php echo $this->language->from_body()[24][0] ?> <span class="required"> *</span></label>
...
function getEmps() {
	...
	$.ajax({
		...
		success: function(data){debugger;
			...
			$('#empsid').html('<?php echo btn_pdf("super/emps/emps_list_pdf/"."'+val+'"."/'+agencyval+'"); ?>');
			// $('#empsid').html('<?php echo btn_pdf("super/emps/emps_list_pdf"); ?>');
				...
				<div class="row" id="tables" style="display:none;">
					<div class="col-sm-12 wrap-fpanel" data-spy="scroll" data-offset="0">                            
						<div class="panel panel-default">
							...
							<!-- Table -->
							<table class="table table-bordered table-hover" id="emp-records" >
								<thead>
									<tr>
